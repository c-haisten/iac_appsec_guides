...
![Alt text for image](/iac_screenshots/find-and-fix-insecure-infrastructure-code-6.png "Optional title")
...
8. Click the Policy details button ![Alt text for image](/iac_screenshots/policy-details-button.png "Optional title") to view guidelines on how to resolve the
...
![Alt text for image](/iac_screenshots/generating-pull-requests-3.png "Optional title")
...
![Alt text for image](/iac_screenshots/identify-exposed-secrets-2.png "Optional title")
...
![Alt text for image](/iac_screenshots/identify-exposed-secrets-3.png "Optional title")
...
![Alt text for image](/iac_screenshots/compliance-in-the-cloud-8.png "Optional title")
...
![Alt text for image](/iac_screenshots/compliance-in-the-cloud-10.png "Optional title")
